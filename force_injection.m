%force injection measurment to zero. 


      fprintf('%s \n', 'which Injection measurement data you would like to force to zero?');
      ...
      if status==0
          ...
          if status==0
              ...
              ImeasPvalue(Injectionbus)=IinjPnew/baseMVA; 
          end
          ...
          if status==0
              ...
              ImeasQvalue(Injectionbus)=IinjQnew/baseMVA; 
          end
